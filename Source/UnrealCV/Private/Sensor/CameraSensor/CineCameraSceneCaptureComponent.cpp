...
void UCineCaptureComponent2D::InitTextureTarget(int filmWidth, int filmHeight)
{
...
void UCineCaptureComponent2D::CaptureLit(TArray<FColor>& Image, int& Width, int& Height)
{
